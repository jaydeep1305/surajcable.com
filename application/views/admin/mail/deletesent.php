	          ...
	          <div class="box box-primary">
	            ...
	            <div class="box-body no-padding">
	              <div class="mailbox-controls">
	                ...
	                <div class="btn-group">
	                  <button type="button" class="btn btn-default btn-sm"><i class="fa fa-trash-alt delete"></i></button>
	              ...
	              <div class="table-responsive mailbox-messages">
	                <table class="table table-hover table-striped">
	                  ...
	                  ?>
							<tr data-mail-sent-id="<?=$mail['mail_sent_id']?>">
			                    <td>
			                    	<div class="icheckbox_flat-blue" aria-checked="false" aria-disabled="false" style="position: relative;">
			                    		<input type="checkbox" name="mail_sent_id_checkbox" style="position: absolute; opacity: 1;" value="<?=$mail['mail_sent_id']?>">
			                    	</div>
			                    </td>
			                    ...
			                    <td class="mailbox-subject">
		                    		<?=character_limiter($mail['subject'],50)?>
			                    </td>
...
<script>
	...
	{	
		...
		$("table tr").dblclick(function(){
			$(this).addClass('selected').siblings().removeClass('selected');
			var mail_sent_id = $(this).attr("data-mail-sent-id");
			location.href = "<?=base_url()."gjmail/sent_view/"?>"+mail_sent_id;
		});

		$(".delete").click(function(){
			var checkbox_array = get_selected_checkboxes_array();
			location.href = "<?=base_url()?>gjmail/deletesentmailpermanent/"+checkbox_array.join('-');
		});
	}
	function get_selected_checkboxes_array()
	{
		var ch_list=Array(); 
		$("input:checkbox[name=mail_sent_id_checkbox]:checked").each(function(){
