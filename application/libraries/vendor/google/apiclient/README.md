...
(in the above example, `https://localhost:8000`).
...
The `authorize` method returns an authorized [Guzzle Client](https://docs.guzzlephp.org/), so any request made using the client will contain the corresponding authorization.
...
In this example we use [StashPHP](https://www.stashphp.com/). Add this to your project with composer:
