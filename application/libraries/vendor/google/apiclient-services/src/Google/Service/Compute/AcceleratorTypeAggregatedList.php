...
class Google_Service_Compute_AcceleratorTypeAggregatedList extends Google_Model
{
   ...
   */
  public function setWarning(Google_Service_Compute_AcceleratorTypeAggregatedListWarning $warning)
  {
    $this->warning = $warning;
  }
  /**
   * @return Google_Service_Compute_AcceleratorTypeAggregatedListWarning
   */
