...
class Google_Service_DLP_GooglePrivacyDlpV2beta2DeidentifyContentRequest extends Google_Model
{
  protected $deidentifyConfigType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2DeidentifyConfig';
   ...
   */
  public function setDeidentifyConfig(Google_Service_DLP_GooglePrivacyDlpV2beta2DeidentifyConfig $deidentifyConfig)
  {
