...
class Google_Service_DLP_GooglePrivacyDlpV2beta2CategoricalStatsHistogramBucket extends Google_Collection
{
  protected $collection_key = 'bucketValues';
  public $bucketSize;
  protected $bucketValuesType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2ValueFrequency';
