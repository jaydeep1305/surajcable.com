...
class Google_Service_DLP_GooglePrivacyDlpV2beta2RecordTransformations extends Google_Collection
{
  ...
  protected $recordSuppressionsType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2RecordSuppression';
