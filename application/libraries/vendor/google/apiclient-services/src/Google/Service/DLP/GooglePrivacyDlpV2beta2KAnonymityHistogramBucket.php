...
class Google_Service_DLP_GooglePrivacyDlpV2beta2KAnonymityHistogramBucket extends Google_Collection
{
  protected $collection_key = 'bucketValues';
  public $bucketSize;
  protected $bucketValuesType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2KAnonymityEquivalenceClass';
  ...
  /**
   * @param Google_Service_DLP_GooglePrivacyDlpV2beta2KAnonymityEquivalenceClass
   */
  ...
  /**
   * @return Google_Service_DLP_GooglePrivacyDlpV2beta2KAnonymityEquivalenceClass
   */
