...
class Google_Service_Resourceviews_Operation extends Google_Collection
{
  ...
  /**
   * @param Google_Service_Resourceviews_OperationError
   */
  ...
  /**
   * @return Google_Service_Resourceviews_OperationError
   */
  ...
  /**
   * @param Google_Service_Resourceviews_OperationWarnings
   */
  ...
  /**
   * @return Google_Service_Resourceviews_OperationWarnings
   */
