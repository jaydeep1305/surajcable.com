...
class Google_Service_DLP_GooglePrivacyDlpV2beta2LDiversityHistogramBucket extends Google_Collection
{
  ...
  /**
   * @return Google_Service_DLP_GooglePrivacyDlpV2beta2LDiversityEquivalenceClass
   */
