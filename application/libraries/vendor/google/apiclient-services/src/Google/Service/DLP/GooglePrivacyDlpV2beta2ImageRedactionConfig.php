...
class Google_Service_DLP_GooglePrivacyDlpV2beta2ImageRedactionConfig extends Google_Model
{
  protected $infoTypeType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2InfoType';
  protected $infoTypeDataType = '';
  public $redactAllText;
  protected $redactionColorType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2Color';
  ...
  /**
   * @param Google_Service_DLP_GooglePrivacyDlpV2beta2Color
   */
  public function setRedactionColor(Google_Service_DLP_GooglePrivacyDlpV2beta2Color $redactionColor)
  {
    $this->redactionColor = $redactionColor;
  }
  /**
   * @return Google_Service_DLP_GooglePrivacyDlpV2beta2Color
   */
