...
class Google_Service_DLP_GooglePrivacyDlpV2beta2FindingLimits extends Google_Collection
{
  protected $collection_key = 'maxFindingsPerInfoType';
  protected $maxFindingsPerInfoTypeType = 'Google_Service_DLP_GooglePrivacyDlpV2beta2InfoTypeLimit';
  protected $maxFindingsPerInfoTypeDataType = 'array';
  public $maxFindingsPerItem;
  public $maxFindingsPerRequest;

  /**
   * @param Google_Service_DLP_GooglePrivacyDlpV2beta2InfoTypeLimit
   */
  ...
  /**
   * @return Google_Service_DLP_GooglePrivacyDlpV2beta2InfoTypeLimit
   */
