...
class Google_Service_DLP_GooglePrivacyDlpV2beta2KMapEstimationHistogramBucket extends Google_Collection
{
  ...
  /**
   * @return Google_Service_DLP_GooglePrivacyDlpV2beta2KMapEstimationQuasiIdValues
   */
