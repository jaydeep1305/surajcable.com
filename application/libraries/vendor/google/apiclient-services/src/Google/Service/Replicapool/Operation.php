...
class Google_Service_Replicapool_Operation extends Google_Collection
{
  ...
  /**
   * @param Google_Service_Replicapool_OperationError
   */
  ...
  /**
   * @return Google_Service_Replicapool_OperationError
   */
  ...
  /**
   * @param Google_Service_Replicapool_OperationWarnings
   */
  ...
  /**
   * @return Google_Service_Replicapool_OperationWarnings
   */
