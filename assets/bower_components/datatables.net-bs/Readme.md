# DataTables for jQuery with styling for [Bootstrap](https://getbootstrap.com/)

This package contains distribution files required to style [DataTables library](https://datatables.net) for [jQuery](https://jquery.com/) with styling for [Bootstrap](https://getbootstrap.com/).
