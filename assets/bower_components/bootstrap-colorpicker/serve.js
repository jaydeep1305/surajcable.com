/*
 ...
 Run it using `node serve` from your terminal and navigate to https://localhost:5000
...
console.log("Your bootstrap-colorpicker development URL is https://localhost:5000");
